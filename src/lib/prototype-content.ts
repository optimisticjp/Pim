...
export const prototypeEvents: EventItem[] = [
  ...
  { id: "cancelled-yatra", slug: "cancelled-yatra", kind: "yatra", scheduleType: "dated", eyebrowGu: "યાત્રા સૂચના", titleGu: "ચાણોદ આધ્યાત્મિક યાત્રા", descriptionGu: "હવામાનની પરિસ્થિતિને ધ્યાનમાં રાખીને આ યાત્રા રદ કરવામાં આવી છે.", startsAt: "2026-09-20", venueGu: "શ્રી માધવાનંદ આશ્રમ — ચાણોદ", ashramId: "chanod", status: "cancelled", verified: false, prototype: true },
];
