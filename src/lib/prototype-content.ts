...
export const heritageModules = [
  ["વારસા સંગ્રહ", "સ્રોતસચેત ઐતિહાસિક નોંધો અને ઉપલબ્ધ પ્રકાશનોનો સંપાદકીય પ્રવેશ.", "/heritage"], ["ઐતિહાસિક પ્રસંગ", "આશ્રમ પરિવારની સ્મૃતિમાં જીવંત રહેલા પ્રસંગોનું સંપાદકીય નિરૂપણ.", "/events"], ["પત્ર અને સંદેશ", "સાધના, સેવા અને જીવનમૂલ્યો સાથે જોડાયેલ વાંચન.", "/publications/parampara-letters"], ["પ્રકાશન", "વેદ રહસ્ય અને આધ્યાત્મિક વાંચનનો સુગમ ગ્રંથાલય પ્રવેશ.", "/publications"], ["ફોટો અભિલેખ", "આશ્રમ કેન્દ્રો અને સામૂહિક પ્રસંગોની સંદર્ભસભર દૃશ્યસ્મૃતિ.", "/ashrams"], ["સત્સંગ અને પ્રવચન", "અધિકૃત ચેનલ પર પાઠ, કથા અને સ્વાધ્યાય સાથે જોડાણ.", "/satsang"],
] as const;
