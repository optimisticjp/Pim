...
export const metadata = {
  ...
  description: "સમિતિ દ્વારા પ્રકાશિત શ્રી માધવાનંદ આશ્રમ પરિવારનાં કેન્દ્રો, સરનામાં અને સંપર્ક માહિતી મેળવો.",
};
    ...
    <header className="relative overflow-hidden border-b border-border bg-surface-soft">
      ...
      <div className="container-site relative py-10 sm:py-14 lg:py-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 max-w-2xl text-[16px] leading-7 text-muted-foreground sm:text-[18px]">આ યાદી Admin માં સમિતિ દ્વારા પ્રકાશિત આશ્રમ રેકોર્ડમાંથી સીધી આવે છે. સરનામું, ફોન અને મેપમાં કરેલો મંજૂર ફેરફાર અહીં જ દેખાશે.</p>
          <div className="mt-5 flex flex-wrap gap-x-5 gap-y-2 text-[13px] font-bold text-sacred-green"><span className="inline-flex items-center gap-1.5"><MapPinned className="size-4" />{ashrams.length} પ્રકાશિત આશ્રમ</span><span className="inline-flex items-center gap-1.5"><ShieldCheck className="size-4" />Draft/Archived નોંધ જાહેરમાં છુપાયેલી</span></div>
        </div>
      </div>
    </header>
