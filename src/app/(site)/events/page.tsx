...
export const metadata: Metadata = {
  ...
  description: "સમિતિ દ્વારા જાહેર કરાયેલા આગામી તિથિ, પૂનમ, સત્સંગ અને વિશેષ કાર્યક્રમોની માહિતી.",
};
