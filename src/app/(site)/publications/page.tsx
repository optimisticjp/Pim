...
export const metadata: Metadata = {
  ...
  description: "સમિતિ દ્વારા પ્રકાશિત વેદ રહસ્યના ડિજિટલ અંકો અને અન્ય આધ્યાત્મિક વાંચન માર્ગો.",
};
    ...
    <section className="border-b border-border bg-[#f2e7d7]">
      <div className="container-site py-10 sm:py-14 lg:py-16">
        <div className="max-w-3xl">
          ...
          <p className="body-large mt-4 max-w-2xl">આ પાનાં પર દેખાતા વેદ રહસ્યના અંકો હવે સીધા સમિતિના Adminમાંથી Publish થાય છે. Draft અથવા Archived અંક જાહેરમાં દેખાતા નથી.</p>
        </div>
      </div>
    </section>
    ...
    <main className="section-pad">
      <div className="container-site">
        <div className="flex flex-col gap-4 border-b border-border pb-6 sm:flex-row sm:items-end sm:justify-between">
          <div><p className="eyebrow">વેદ રહસ્ય</p><h2 className="mt-3 font-serif text-3xl font-bold text-primary-strong">પ્રકાશિત ડિજિટલ અંકો</h2></div>
        ...
        <dl className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
          <div className="rounded-2xl border border-border bg-surface p-4"><dt className="text-sm text-muted-foreground">પ્રકાશિત અંક</dt><dd className="mt-1 font-serif text-3xl font-bold text-primary">{guNumber(issues.length)}</dd></div>
        ...
        </article>)}</div> : <div className="mt-7 rounded-2xl border border-dashed border-border bg-surface p-7 text-sm text-muted-foreground">હાલ કોઈ ડિજિટલ અંક પ્રકાશિત નથી. Adminમાંથી Publish થયેલા અંક અહીં આપમેળે દેખાશે.</div>}
