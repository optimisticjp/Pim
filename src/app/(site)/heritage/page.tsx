...
export default function HeritagePage() {
  ...
  return <main>
    ...
    <section className="border-b border-border bg-[#37151c] text-white"><div className="container-site grid gap-8 py-12 lg:grid-cols-[.72fr_1.28fr] lg:items-center lg:gap-14"><GuruPortrait profile={guruProfiles[0]} className="sacred-arch mx-auto aspect-[4/5] w-full max-w-sm" priority/><div><p className="text-xs font-bold text-[#efbd6b]">પરંપરાનું દૃશ્ય અભિલેખ</p><h2 className="mt-3 font-serif text-3xl font-bold sm:text-4xl">{guruProfiles[0].nameGu}</h2><p className="mt-4 max-w-2xl leading-8 text-[#d8c7bb]">Legacy About Us પૃષ્ઠમાં નામ અને ચિત્ર સાથે નોંધાયેલી ૧૭ આધ્યાત્મિક વ્યક્તિત્વોની પસંદ કરેલી દૃશ્યસૂચિ.</p><Link href="/parampara" className="mt-6 inline-flex min-h-11 items-center gap-2 rounded-full bg-white px-5 font-bold text-primary">ગુરુપરંપરા જુઓ <ArrowRight className="size-4"/></Link></div></div></section>

    <section className="section-pad"><div className="container-site"><SectionHeading eyebrow="સંત-સ્વામી ચિત્રસંગ્રહ" title="સ્રોત સાથે ઓળખાયેલી વ્યક્તિત્વ છબીઓ" description="ચિત્રો હાલ legacy source પરથી stagingમાં લોડ થાય છે અને ભાવિ મંજૂર local/R2 migration માટે manifestમાં નોંધાયેલા છે."/><div className="mt-8 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">{featuredGuruProfiles.map(profile=><GuruCard key={profile.id} profile={profile}/>)}</div></div></section>
    ...
    <section className="border-y border-border bg-[#f1e5d3] section-pad"><div className="container-site grid gap-8 lg:grid-cols-[.75fr_1.25fr]"><div><ScrollText className="size-7 text-gold-deep"/><p className="eyebrow mt-4">ઐતિહાસિક પત્રો</p><h2 className="section-title mt-3 text-primary-strong">માધવાનંદ પરિવાર માટે સાચવાયેલ પત્રવારસો</h2></div><article className="rounded-[1.4rem] border border-[#cdb18d] bg-[#fffaf1] p-6 sm:p-8"><p className="font-serif text-2xl font-bold leading-relaxed text-primary">Legacy સ્રોત મુજબ સ્વામી શ્રી દ્વારા લખાયેલા ઐતિહાસિક પત્રો માધવાનંદ પરિવાર માટે સંરક્ષિત કરવામાં આવ્યા છે.</p><p className="mt-4 leading-8 text-muted-foreground">સ્રોત આ પત્રસંગ્રહ માટે શ્રી દેવરાજભાઈ પ્રેમજીભાઈ મોનપરા (નવડા)નો આભાર માને છે. મૂળ scan URLs ઉપલબ્ધ થયા પછી આ તૈયાર અભિલેખમાં scan preview ઉમેરાશે; કોઈ કલ્પિત scan રજૂ કરાયેલ નથી.</p><a href="https://omshreemadhavanandji.org/letter.php" target="_blank" rel="noreferrer" className="mt-6 inline-flex min-h-11 items-center gap-2 font-bold text-primary">મૂળ પત્રસંગ્રહનો સંદર્ભ <ExternalLink className="size-4"/></a></article></div></section>

    <section className="border-y border-border bg-surface section-pad">
      <div className="container-site">
        <SectionHeading eyebrow="ડિજિટલ ગ્રંથાલય" title="વેદ રહસ્યના ઉપલબ્ધ વારસા અંકો" description="જૂની વેબસાઇટમાંથી રિપોઝિટરીમાં પહેલેથી નોંધાયેલા ત્રણ અંકો. મૂળ ફાઇલોનું ભાવિ R2 સ્થાનાંતરણ અને સમિતિ મંજૂરી બાકી છે." />
