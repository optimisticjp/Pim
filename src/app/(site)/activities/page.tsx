...
export const metadata: Metadata = {
  ...
  description: "સમિતિ દ્વારા પ્રકાશિત સેવા પ્રવૃત્તિઓ અને ઉપલબ્ધ યુવક મંડળ જોડાણ.",
};
