...
export default function ActivitiesPage() {
  return <>
    <section className="border-b border-border bg-[#e8eee8]"><div className="container-site py-12 sm:py-16 lg:grid lg:grid-cols-[1.08fr_.92fr] lg:items-end lg:gap-12"><div><div className="eyebrow text-[#31574f]">સેવા એટલે સાધના</div><h1 className="display-title mt-4 text-[#21433d]">સેવા દ્વારા સમાજ સાથે, સંસ્કાર દ્વારા નવી પેઢી સાથે જોડાણ</h1></div><div className="mt-5 lg:mt-0"><p className="body-large">ભક્તિ, જવાબદારી અને સામૂહિક ભાવ સાથે આશ્રમ પરિવારની સેવાયાત્રા જાણો. આપ કઈ રીતે સહયોગ આપવા ઇચ્છો છો તે સરળતાથી જણાવો.</p><div className="mt-6 flex flex-col gap-3 sm:flex-row"><Link href="#join" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-primary px-5 font-bold text-white">સેવા માટે જોડાઓ <ArrowRight className="h-4 w-4" aria-hidden="true" /></Link><Link href="?track=youth#join" className="inline-flex min-h-12 items-center justify-center rounded-full border border-primary/30 px-5 font-bold text-primary">યુવા જોડાણ</Link></div></div></div></section>
