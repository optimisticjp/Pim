...
export const metadata: Metadata = {
  title: "સેવા પ્રવૃત્તિઓ | શ્રી માધવાનંદ આશ્રમ",
  description: "સમિતિ દ્વારા જાહેર કરાયેલી સેવા પ્રવૃત્તિઓ અને સેવા માટે જોડાવાનો માર્ગ.",
};
...
export default async function ActivitiesPage() {
  ...
  return <>
    ...
    <section className="section-pad"><div className="container-site rounded-[1.6rem] bg-[#294c45] p-6 text-white sm:p-9 lg:grid lg:grid-cols-[.7fr_1.3fr] lg:items-center lg:gap-12"><div className="flex items-center gap-3"><UsersRound className="size-8 text-[#f1bd67]" /><div className="eyebrow text-[#f1bd67]">સહભાગિતા</div></div><div className="mt-6 lg:mt-0"><h2 className="font-serif text-3xl font-bold sm:text-4xl">સેવા માટે જોડાઓ</h2><p className="mt-4 max-w-3xl text-[16px] leading-8 text-[#dfebe7]">જાહેર કરાયેલા સેવા ક્ષેત્રોમાં સહભાગી થવા માટે તમારી રસની વિગતો સ્વયંસેવક ફોર્મ દ્વારા મોકલી શકાય છે.</p><Link href="/volunteer" className="mt-6 inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#fff4e5] px-5 font-bold text-primary">સેવા માટે રસ નોંધાવો <ArrowRight className="size-4" /></Link></div></div></section>
  </>;
}
