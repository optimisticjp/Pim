...
This file separates verified legacy/public information from editorial copy created for the redesign. Committee review is required before launch.
...
Verified legacy contact data included in seed content:
...
Other branch names are migrated only as directory names from the legacy branch list. No phone/address is invented for them.
